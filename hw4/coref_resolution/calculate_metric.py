...
flags.DEFINE_string("test_data", "data/test.tsv", "Test tsv file with true labels.")

flags.DEFINE_string("predictions", "ckpt_coref/test.tsv.predictions.tsv", "Predictions tsv file.")
# flags.DEFINE_string("predictions", None, "Predictions tsv file.")

flags.DEFINE_string("output", "results_coref.json", "Output json file.")
