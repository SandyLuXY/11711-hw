...
def main(_):
  preds = pd.read_csv(FLAGS.predictions, sep="\t",index_col=False)
  true = pd.read_csv(
  ...
  print("Ekman Emotion,Precision,Recall,F1")
  print('macro_avg,%.2f,%.2f,%.2f'%(results['macro_precision'],results['macro_recall'],results['macro_f1']))
  for i in range(num_emotions):
    ...
    print('%s,%.2f,%.2f,%.2f'%(emotion,results[emotion+'_precision'],results[emotion+'_recall'],results[emotion+'_f1']))
