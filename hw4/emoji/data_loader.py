...
def load_and_cache_examples(args, tokenizer, mode):
    ...
    # all_embed = torch.tensor(np.load(os.path.join(args.data_dir, '{}.npy'.format(mode))))#[:,np.newaxis,:])
    # print('$$$$$$$$$$$$$$$$$$$$$$$$$4',all_input_ids.shape, all_embed.shape)

    dataset = TensorDataset(all_input_ids, all_attention_mask, all_token_type_ids, all_labels)#, all_embed)
    return dataset
