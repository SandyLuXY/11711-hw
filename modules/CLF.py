...
class CLF_comb(nn.Module):
    def __init__(self, in_features, out_features, dropout_rate = 0.3):
        super(CLF_comb, self).__init__()
        self.clf1= CLF(in_features, out_features, dropout_rate)
        self.clf2= CLF(in_features, out_features, dropout_rate)
